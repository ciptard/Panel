	...
	(function(){
		$('.toggle_menu').on('click',function(){
			...
			if($(this).hasClass('on')){
				...
				$('#morfy_panel .sidebar').animate({width:'53px'});
				$('.header,.footerm,.main').addClass('menu_is_hidden');
				...
				$('.header,.footerm,.main').removeClass('menu_is_hidden');
				$('.menu li a span').delay(800).fadeIn('fast');
